...
import modelo.Time;
import database.*;
import database.factory.Conexao;
import database.factory.ConexaoFactory;
import java.util.*;
import java.sql.*;
...
public class TimeDAO {
   ...
   private Conexao databaseFac=null;
   ...
   */
    public void adicionarTime(Time time) throws Exception
    {
        ...
        try
        {    //fazendo a conexao
             database =  ConexaoBD.getInstance();
   ...
   public Iterator consultarTimes() throws Exception
    {
        ...
        try
        {
            ...
            String sql = null;
           //DAO usando a classe conexaoBD sendo um singleton
           database =  ConexaoBD.getInstance();
           System.out.println("exibindo objeto na memória - n chamadas e eh o mesmo objeto singleton"+database);
           con = database.getConexao();

         /* // usando factory
           databaseFac = ConexaoFactory.obterConexao("Post");
           con = databaseFac.getConexao();
           */
